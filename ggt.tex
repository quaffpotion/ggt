        ...
        \end{enumerate}
                ...
                \begin{claim*}
                    ...
                    \begin{proof}
                        ...
                        (sketch 2) We will show for every point \(p \in \rxy\) and every open quadrant \(Q\) with \(p \in Q\) that there exists some \(r \in R \cap Q\). Let \(q=(q_1,q_2)\) be the point where \(Q\) is based and label the halfspaces so that \(Q=q_1^{+} \times q_{2}^{+}\).
