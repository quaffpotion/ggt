...
xxxxxasdafsdfasdfcccccbbbbasdfasdfasdsdf
...
\begin{defn}
    ...
    \begin{enumerate}
        ...
        \item \label{item:interior} The interior of \(\sigma\) doesn't use \(x_{0}\), that is \(\partial_{0} \sigma (i) = x_{0} \implies i=1\) and \(\partial_{1} \sigma (i)=x_{0} \implies i=-1\).
    \end{enumerate}
\end{defn}
\begin{defn}
	[straddle]
