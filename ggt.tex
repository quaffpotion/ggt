...
\begin{lem}
    ...
    Given maps as ... as can extend by collapsing the top tree to a point
\end{lem}

\begin{defn}
    [Cocompact by factor]
    \label{defn:cocompactcrossfactor} 
    looks like cocomapct cross factor
\end{defn}
