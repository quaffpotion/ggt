...
\begin{thm}
	...
	Let \(X=T_{1} \times T_{2} \times T_{3}\) where each \(T_{i}\) is a locally finite tree. If \(K\) is a subcomplex of \(X\) that is connected, has cellular-product-convex fibers, and has connected fibers then \(K\) is also cellular-product-convex.
\end{thm}
