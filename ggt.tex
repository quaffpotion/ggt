...
\begin{lem}[Coloring Lemma]
    ...
    \begin{proof}
        (Sketch) Suppose the coloring lemma were false, then there exists some \(K\) satisfying the setup with \(K > 0\). Then after snipping we obtain \(0 < K' < K\). However, this is impossible.
    \end{proof}
\end{lem}
