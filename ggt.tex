...
\begin{lem}
	...
	If \(S \subseteq \mathbb{R}^{3}\) is connected in \(xy\)-planes then \(yS\) is connected in \(xz\)-planes. \textcolor{mypink1}{Issue with disconnected points having different \(z\)-coordinates. Try doing version where we assume \(S\) is connected and connected in all coordinate planes and we want to conclude that all fills are also connected in all coordinate directions} 
