...
\item         \textcolor{orange}{[warning] When we use this later, we don't have any conditions on the trees. So in this proof we should go to minimal actions to use Bestvina and have a remark saying it still applies}
     \item    \textcolor{orange}{[warning] Can we just assume locally finite on both and not need to pull back as much?}
        \end{itemize}
