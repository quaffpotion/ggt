...
\begin{lem}
    ...
    \begin{proof}
        ...
        \end{enumerate}
                ...
                Hence, either \(\ell \cap \rxy = \varnothing\) or \(r \cap \rxy = \varnothing\) as needed, so \(\rxy\) has connected \(x\)-fibers. Similarly, \(\ryx\) also has connected fibers. 


                (... now we need to show they are equal)
