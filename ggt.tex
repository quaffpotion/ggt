...
\begin{lem}
    ...
    \label{lem:confib} 
    Let $f: L\to T$ be an equivariant map from a 2-complex to a tree. Let $X = \Lambda(L,f,\Gamma)$ a subgraph coning \ref{defn:coneoff} where $\Gamma$ is a subgraph of the 1-skeleton of $L$.
