...
\end{lem}
\begin{proof}
    We claim that both expansion and collapse moves produce $G$-trees with a locally finite 
\end{proof}
...
\begin{pro}
    [Collapse Preserves Hyperbolicity]
